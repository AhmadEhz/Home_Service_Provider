...
public class HibernateBaseServiceImpl<E, ID, R extends HibernateBaseRepository<E, ID>> implements HibernateBaseService<E, ID> {
    protected final R repository;

    protected HibernateBaseServiceImpl(R repository) {
